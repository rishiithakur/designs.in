...
export function InteractiveProductCard({
  ...
  return (
    <div
      ...
      style={style}
      className={cn(
        "relative w-full max-w-[340px] aspect-[9/12] rounded-3xl bg-card shadow-lg group",
    ...
    >
      ...
      >
        ...
        <div className="flex items-start justify-between rounded-xl border border-white/10 bg-white/5 p-4 backdrop-blur-md">
          ...
          <img src={logoUrl} alt="Brand Logo" className="h-6 w-auto brightness-0 invert" />
        </div>

        {/* Price Tag - Absolute position for pixel perfection */}
        <div className="absolute top-[108px] left-5">
          <div className="rounded-full bg-black/40 px-4 py-1.5 text-[10px] font-bold text-white backdrop-blur-sm border border-white/10 uppercase tracking-widest">
            {price}
          </div>
        </div>
